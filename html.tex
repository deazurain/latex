...
\lstdefinelanguage{javascript}{
	morekeywords={break, case, catch, continue, debugger, default,
...
\lstdefinelanguage{css}{
	...
	morestring=[b]',
	morestring=[b]",
	moredelim=[s][]{:}{;}, % Typesets characters between /@ and @/ delimeters in boldface.
}


% light
\definecolor{codeText}{HTML}{262721}
\definecolor{codeBackground}{HTML}{F5F5F5}
\definecolor{codeKeyword}{HTML}{3691a6}
\definecolor{codeParameter}{HTML}{FD941F}
\definecolor{codeComment}{HTML}{aeaeae}

% dark
% \definecolor{codeText}{HTML}{F2F2F2}
% \definecolor{codeBackground}{HTML}{262721}
% \definecolor{codeKeyword}{HTML}{47BED9}
% \definecolor{codeParameter}{HTML}{FD941F}
% \definecolor{codeComment}{HTML}{75715e}

\lstset{
	basicstyle=\normalfont\small\ttfamily\color{codeText},
	backgroundcolor=\color{codeBackground},
	keywordstyle=\color{codeKeyword},
	commentstyle=\color{codeComment},
	stringstyle=\color{codeParameter},
	showstringspaces=false,
	breaklines=true,
	captionpos=b,
	numbers=none,
	numbersep=8pt,
	numberstyle=\normalfont\small\ttfamily\color{codeComment},
	tabsize=4,
	aboveskip=6pt,
	belowskip=6pt
}